                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card h-100" style=" text-align: center; padding-top:10px;">
                        ...
                        <div class="card-body">
                            ...
                            <span id="product-qty" value="1">
                            <span id="product-sku" value="{{ $product->SKU }}"></span>
                        </div>
                        <div class="clearfix m-2">
                            <button class="btn btn-success pull-right" data-bind="{click: addNewProduct}">Add to cart
                            </button>
                        </div>
